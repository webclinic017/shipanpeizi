...
class ChartColors {
  ...
  static const Color gridColor = Color(0xffF8F8FF);
  ...
  static const Color upColor = Color(0xffFF3030);
  static const Color dnColor = Color(0xff32CD32);
  ...
  //实时线颜色等
  static const Color realTimeBgColor = Color(0xff4C86CD);
...
class ChartStyle {
  ...
  //点与点的距离
  static const double pointWidth = 5.0;
  ...
  //vol柱子宽度
  static const double volWidth = 4;

  //macd柱子宽度
  static const double macdWidth = 2.0;

  //垂直交叉线宽度
  static const double vCrossWidth = 3;
